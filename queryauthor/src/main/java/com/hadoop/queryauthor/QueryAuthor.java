...
public class QueryAuthor {
	...
	public static class BookMapper extends Mapper<Object, Text, Text, Text> {
		...
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			for (String line : lines) {
				...
				String authorName= context.getConfiguration().get("querried_author");
	...
	public static void main(String[] args) throws Exception {
		...
		if (otherArgs.length != 3) {
			System.err.println("Usage: Querried author <in> <out> <qurried author>");
			System.exit(2);
		}
        conf.set("querried_author", args[2]);
		
		Job job = Job.getInstance(conf, "QueryAuthor");
